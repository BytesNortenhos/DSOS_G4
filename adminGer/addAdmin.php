...
<body class="bg-primary flex justify-top">
    <div class="w-screen flex flex-col items-center justify-center h-screen">
        <h1 class="text-secondary text-6xl font-bold">ADICIONAR ADMINISTRADOR</h1>
        <a class="text-secondary text-xl">No seguinte formulário poderá registar novos administradores!</a>
        <form class="flex flex-col justify-center items-center content-center mt-12 w-full" action="insereAdmin.php"
            method="POST" onsubmit="addAdmin(); return false;">
            <input
                class="h-10 w-96 rounded-2xl bg-primary border-solid border-secondary border-2 px-2 pl-2 text-secondary"
                type="text" id="nomeAdmin" placeholder="Nome">
            <input
                class="h-10 w-96 mt-5 rounded-2xl bg-primary border-solid border-secondary border-2 px-2 pl-2 text-secondary"
                type="text" id="emailAdmin" placeholder="Email">
            <input
                class="h-10 w-96 mt-5 rounded-2xl bg-primary border-solid border-secondary border-2 px-2 pl-2 text-secondary"
        ...
        <div style="display: none;" id="yellowToast"
            ...
            <div id="hs-toast-soft-color-yellow-label" class="flex p-4">
                O Administrador que tentou registar já está registado!
                ...
                <div class="ms-auto">
                    <button type="button"
                        ...
                        <svg class="shrink-0 size-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                            viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                            stroke-linecap="round" stroke-linejoin="round" onclick="closeToast('yellowToast');">
                            <path d="M18 6 6 18"></path>
                            <path d="m6 6 12 12"></path>
                        </svg>
                    </button>
