...
<head>
    ...
    <title>Registar medicamentos</title>
</head>
    ...
    <div class="w-screen flex flex-col items-center justify-center h-screen">
        ...
        <form class="flex flex-col justify-center items-center content-center mt-12 w-full" action="insereMed.php"
            ...
            <input
                ...
                type="text" id="nomeMed" placeholder="Nome">
            <input
                class="h-10 w-96 mt-5 rounded-2xl bg-primary border-solid border-secondary border-2 px-2 pl-2 text-secondary"
                type="text" id="marcaMed" placeholder="Marca">
                <input
                class="h-10 w-96 mt-5 rounded-2xl bg-primary border-solid border-secondary border-2 px-2 pl-2 text-secondary"
                type="text" id="princAtivo" placeholder="Principio ativo">
                <input
                class="h-10 w-96 mt-5 rounded-2xl bg-primary border-solid border-secondary border-2 px-2 pl-2 text-secondary"
                type="text" id="doseMed" placeholder="Dose">
                <input
                class="h-10 w-96 mt-5 rounded-2xl bg-primary border-solid border-secondary border-2 px-2 pl-2 text-secondary"
                type="text" id="tomaMed" placeholder="Modo de toma">
            <button
        ...
        <div style="display: none;" id="yellowToast"
            ...
            <div id="hs-toast-soft-color-yellow-label" class="flex p-4">
                O medicamento que tentou registar já está registado!
